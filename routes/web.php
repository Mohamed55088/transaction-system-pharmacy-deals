...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('customer/{supplier}', [SupplierController::class, 'infoCustomer'])->name('info-supplier');
    Route::delete('suppliers', [SupplierController::class, 'destroy']);
    Route::put('suppliers/{customer}}', [SupplierController::class, 'update'])->name('edit-supplier');
    ...
    Route::get('purchases/{money}', [PurchaseController::class, 'show'])->name('edit-purchase');
