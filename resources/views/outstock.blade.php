...
@push('page-header')
    <div class="col-sm-12">
        <h3 class="page-title">المنتجات غير متوفرة</h3>
        <ul class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('products') }}">الأدوية</a></li>
            <li class="breadcrumb-item active">المنتجات غير متوفرة</li>
        </ul>
    </div>
@endpush
...
@section('content')
                            ...
                            <tbody>
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        <td><span class="btn btn-sm bg-danger-light">فقط {{ $product->quantity }}</span>
                                        </td>
    ...
    <!-- حذف Modal -->
    <x-modals.delete :route="'products'" :title="'المنتج غير متوفر'" />
    <!-- /حذف Modal -->
@endsection
