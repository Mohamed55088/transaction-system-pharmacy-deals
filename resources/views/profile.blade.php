            ...
            <div class="profile-header">
                <div class="row align-items-center">
                    <div class="col-auto profile-image">
                        <a href="#">
                            <img class="rounded-circle" alt="صورة المستخدم"
                    ...
                    <div class="col ml-md-n2 profile-user-info">
                        ...
                        منطقة زمنية: <h5>{{ date_default_timezone_get() }}</h5>
                        التاريخ والوقت الحالي: <h5>{{ date('d M,Y h:i:s a', time()) }}</h5>
                    </div>
                </div>
            </div>
