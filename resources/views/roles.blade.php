...
@push('page-header')
    ...
    <div class="col-sm-5 col">
        <a href="#add_role" data-toggle="modal" class="btn btn-primary float-right mt-2">إضافة دور</a>
    </div>
@endpush
...
@section('content')
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">إضافة دور</h5>
    ...
    <!-- حذف Modal -->
    <x-modals.delete :route="'roles'" :title="'الأدوار'" />
    <!-- /حذف Modal -->
@endsection
